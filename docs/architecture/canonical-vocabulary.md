...
| **Road Object** | Entità stradale classificata del Road Object Layer, statica o dinamica, descritta almeno da categoria, fonte, posizione, direzione, corsia, timestamp, Confidence e Verification Status. La sua relazione con Base Map e Live Road Layer dipende da permanenza e stato, senza duplicarne l'ownership. |
| **VEO Context** | Contratto versionato del contesto utile all'unico assistente generale e di navigazione: raccoglie stato qualificato del Journey, guida e conversazione, distinguendo sempre dati verificati, dedotti e non disponibili. Non esegue comandi e non stabilisce la verità stradale. |
