...
- Documentazione Expo corrente verificata: `build.<profile>.ios.image` è il percorso supportato; `macos-sequoia-15.6-xcode-16.4` è immagine supportata e raccomandata per SDK 54 se non si vuole usare Xcode 26.
